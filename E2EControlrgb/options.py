...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--batch_size', type=int, default=32, help='batch size in training')
        ...
        self.parser.add_argument('--model', type=str, default='Fusion')
        ...
        self.parser.add_argument('--full_seq', type=str,  default={'seq-11', 'seq-12', 'seq-14', 'seq-15', 'seq-13'})
                                 #default={'seq-11', 'seq-12', 'seq-14', 'seq-15', 'seq-01', 'seq-02', 'seq-04', 'seq-05', 'seq-07', 'seq-08', 'seq-10',
                                 #         'seq-13', 'seq-03', 'seq-06', 'seq-09'})

        # train options
        self.parser.add_argument('--epoch', default=10, type=int, help='number of epoch in training')
        ...
        self.parser.add_argument('--train_seq', type=str, default={'seq-11', 'seq-12', 'seq-14', 'seq-15'})
        ...
        self.parser.add_argument('--weights', type=str, default='epoch_%03d.pth.tar' % 100)
