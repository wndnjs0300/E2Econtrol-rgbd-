...
class net_vit_from_scratch(nn.Module):
    def __init__(
        ...
        self.post_dense = nn.Linear(self.embedding_dim, 15)
    ...
    def forward(self, img):                
        ...
        cmdvel_class = self.post_dense(x)
...
class net_vit_pretrain(nn.Module):
    def __init__(self, feat_dim_regression_head = 15, cmdvel_dim = 2):
    ...
    def forward(self, x):
        ...
        cmdvel_class = self.head_MLP(self.relu(cls_token_out))
